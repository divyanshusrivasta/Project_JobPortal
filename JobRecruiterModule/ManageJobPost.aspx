<%@ Page Title="" Language="C#" MasterPageFile="~/JobRecruiterModule/JobRecruiterMaster.Master" AutoEventWireup="true" CodeBehind="ManageJobPost.aspx.cs" Inherits="Project_JobPortal_0507.JobRecruiterModule.ManageJobPost" %>
...
<table>
        <tr>
            <td>
                <asp:GridView ID="gvjobpost" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <%#Eval("JobPostStatus").ToString()=="0" ? "Active":"Blocked" %>
                            </ItemTemplate>
                        </asp:TemplateField>
