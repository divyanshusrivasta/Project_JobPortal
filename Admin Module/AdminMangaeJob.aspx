<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Module/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminMangaeJob.aspx.cs" Inherits="Project_JobPortal_0507.Admin_Module.AdminMangaeJob" %>
...
<table>
    ...
    <td><asp:TextBox ID="txtjorecruitername" runat="server" placeholder="Job Recruiter Name"></asp:TextBox>
        ...
        <tr>
            <td>
                <asp:GridView ID="gvadminjobpost" runat="server" AutoGenerateColumns="False" OnRowCommand="gvadminjobpost_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="btnblock" runat="server" Text='<%#Eval("JobPostStatus").ToString()=="0" ? "Active":"Blocked" %>' CommandName="block" CommandArgument='<%#Eval("JobPostId") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
